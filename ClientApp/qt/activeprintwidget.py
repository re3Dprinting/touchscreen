...
class Ui_ActivePrintWidget(object):
    def setupUi(self, ActivePrintWidget):
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("img/resume.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.ResumePrint.setIcon(icon5)
        ...
        self.Fan.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("img/fanoff.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Fan.setIcon(icon6)

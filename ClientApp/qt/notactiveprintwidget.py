...
class Ui_NotActivePrintWidget(object):
    def setupUi(self, NotActivePrintWidget):
        ...
        NotActivePrintWidget.resize(800, 192)
        NotActivePrintWidget.setMaximumSize(QtCore.QSize(800, 480))
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(NotActivePrintWidget)
        ...
        self.Fan = QtWidgets.QPushButton(NotActivePrintWidget)
        ...
        self.CoolDown = QtWidgets.QPushButton(NotActivePrintWidget)

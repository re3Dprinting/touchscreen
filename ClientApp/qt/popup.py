...
class Ui_PopUpWindow(object):
    def setupUi(self, PopUpWindow):
        ...
        self.verticalLayout = QtWidgets.QVBoxLayout(PopUpWindow)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setSpacing(0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.popup_title = QtWidgets.QLabel(PopUpWindow)
        ...
        self.popup_message = QtWidgets.QLabel(PopUpWindow)
        font = QtGui.QFont()
        ...
        self.popup_details = QtWidgets.QLabel(PopUpWindow)
        font = QtGui.QFont()
        ...
        self.popup_button = QtWidgets.QPushButton(PopUpWindow)

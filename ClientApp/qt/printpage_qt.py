...
class Ui_PrintPage(object):
    def setupUi(self, PrintPage):
        ...
        self.verticalLayout = QtWidgets.QVBoxLayout(PrintPage)
        ...
        self.test.setIcon(icon3)
        self.test.setIconSize(QtCore.QSize(160, 40))
        self.test.setObjectName("test")
        self.verticalLayout_6.addWidget(self.test)

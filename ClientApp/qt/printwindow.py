...
class Ui_PrintWindow(object):
    def setupUi(self, PrintWindow):
        ...
        self.pathlabel = QtWidgets.QLabel(self.SD)
        font = QtGui.QFont()
        ...
        self.pathlabel1 = QtWidgets.QLabel(self.USB)
        font = QtGui.QFont()
        font.setPointSize(14)
        self.pathlabel1.setFont(font)
        self.pathlabel1.setObjectName("pathlabel1")
        self.uppervertLayout1.addWidget(self.pathlabel1)
        ...
        self.pathlabel2 = QtWidgets.QLabel(self.Local)
        font = QtGui.QFont()
        font.setPointSize(14)
        self.pathlabel2.setFont(font)
        self.pathlabel2.setObjectName("pathlabel2")
        self.uppervertLayout2.addWidget(self.pathlabel2)
        ...
        self.pushbutton_up1 = QtWidgets.QPushButton(self.Local)
        self.pushbutton_up1.setMinimumSize(QtCore.QSize(0, 50))
        self.pushbutton_up1.setObjectName("pushbutton_up1")
        self.verticalLayout2.addWidget(self.pushbutton_up1)
        self.pushbutton_open1 = QtWidgets.QPushButton(self.Local)
        self.pushbutton_open1.setMinimumSize(QtCore.QSize(0, 50))
        self.pushbutton_open1.setObjectName("pushbutton_open1")
        self.verticalLayout2.addWidget(self.pushbutton_open1)
        spacerItem1 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout2.addItem(spacerItem1)
        self.pushbutton_print1 = QtWidgets.QPushButton(self.Local)
        self.pushbutton_print1.setMinimumSize(QtCore.QSize(0, 100))
        self.pushbutton_print1.setObjectName("pushbutton_print1")
        self.verticalLayout2.addWidget(self.pushbutton_print1)
    ...
    def retranslateUi(self, PrintWindow):
        ...
        self.pathlabel.setText(_translate("PrintWindow", "Files on Viki SD Card"))
        ...
        self.pathlabel1.setText(_translate("PrintWindow", "TextLabel"))
        ...
        self.pathlabel2.setText(_translate("PrintWindow", "TextLabel"))
        item = self.LocalFileList.horizontalHeaderItem(0)
        item.setText(_translate("PrintWindow", "Name"))
        item = self.LocalFileList.horizontalHeaderItem(1)
        item.setText(_translate("PrintWindow", "Size"))
        self.pushbutton_up1.setText(_translate("PrintWindow", "Up One Folder"))
        self.pushbutton_open1.setText(_translate("PrintWindow", "Open Folder"))
        self.pushbutton_print1.setText(_translate("PrintWindow", "Start Print"))

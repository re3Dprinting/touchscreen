...
"")
        ...
        self.w_buttonBox.setGeometry(QtCore.QRect(80, 190, 291, 32))
        ...
        self.w_runout_message_label.setGeometry(QtCore.QRect(50, 70, 291, 41))
        font = QtGui.QFont()
        ...
        self.w_runout_detail_label = QtWidgets.QLabel(self.frame)
        self.w_runout_detail_label.setGeometry(QtCore.QRect(50, 120, 281, 51))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.w_runout_detail_label.setFont(font)
        self.w_runout_detail_label.setText("")
        self.w_runout_detail_label.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.w_runout_detail_label.setWordWrap(True)
        self.w_runout_detail_label.setObjectName("w_runout_detail_label")

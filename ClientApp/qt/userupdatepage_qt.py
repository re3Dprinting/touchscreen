...
class Ui_UserUpdatePage(object):
    def setupUi(self, UserUpdatePage):
        ...
        self.SoftwareList.setGeometry(QtCore.QRect(9, 9, 189, 342))
        ...
        self.DebugOutput.setGeometry(QtCore.QRect(309, 9, 256, 192))
        ...
        self.quickWidget = QtQuickWidgets.QQuickWidget(self.widget_2)
        self.quickWidget.setGeometry(QtCore.QRect(80, 50, 261, 281))
        self.quickWidget.setResizeMode(QtQuickWidgets.QQuickWidget.SizeRootObjectToView)
        self.quickWidget.setSource(QtCore.QUrl("qrc:/qml/CustomTable.qml"))

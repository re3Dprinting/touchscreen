...
class Ui_UserUpdate(object):
    def setupUi(self, UserUpdate):
        ...
        self.Rollback = QtWidgets.QPushButton(UserUpdate)
        self.Rollback.setMaximumSize(QtCore.QSize(150, 100))
        self.Rollback.setObjectName("Rollback")
        self.verticalLayout.addWidget(self.Rollback)
    ...
    def retranslateUi(self, UserUpdate):
        ...
        self.Update.setText(_translate("UserUpdate", "Update"))
        self.Rollback.setText(_translate("UserUpdate", "Rollback"))

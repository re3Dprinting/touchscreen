...
class Ui_NotActivePrintWidget(object):
    def setupUi(self, NotActivePrintWidget):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/img/img/Extruder_with_Bed_2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/img/img/Extruder_0.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/img/img/Temperature_3.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
